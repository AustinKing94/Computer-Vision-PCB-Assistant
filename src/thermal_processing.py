...
def capture_thermal_image(thermal_save_path):
    ...
    try:
        ...
        # Reshape flat array into the 24x32 sensor grid
        ...
        # Apply colormap (dark=cool, bright=hot)
        ...
        # MLX90640 occasionally drops a frame over I2C - retry
